...
Now we have both node exporter and prometheus are running, so let's take a look to the prometheus dashboard. you can access your prometheus by browsing it at `http://your-address:9090`. The dashboard should be like this
