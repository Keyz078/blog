...
![prometheus-1](https://blog.keyz.my.id/assets/images/prometheus-1.png)

If we go to `status > targets` it show all the job we added

![prometheus-2](https://blog.keyz.my.id/assets/images/prometheus-2.png)

So, how can we know the metrics was stored? go back to `graph > browser icon > browse some metrics` 

![prometheus-3](https://blog.keyz.my.id/assets/images/prometheus-3.png)
...
![prometheus-4](https://blog.keyz.my.id/assets/images/prometheus-4.png)
